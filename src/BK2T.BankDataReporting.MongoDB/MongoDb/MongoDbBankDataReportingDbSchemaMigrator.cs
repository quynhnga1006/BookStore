...
{
    public class MongoDbBankDataReportingDbSchemaMigrator : IBankDataReportingDbSchemaMigrator , ITransientDependency
    {
        private readonly IServiceProvider _serviceProvider;

        public MongoDbBankDataReportingDbSchemaMigrator(IServiceProvider serviceProvider)
        {
